...
<html>
    <head>
        <meta charset="utf-8" />
        <title> @yield('title') | Entertainment Incubator</title>
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a target="_blank" href="{{ route('index') }}" class="logo">
                        <span>
                            <h4 class="text-white pt-2"><strong>Enincu Admin</strong></h4>
                        </span>
                        <i>
                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="javascript: void(0);"> <i class="fa-solid fa-basket-shopping"></i> <span>Our Products</span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('products.create') }}">Add New Product</a></li>
                                    <li><a href="{{ route('products.index') }}">View All Product</a></li>
                                </ul>
                            </li>
                            <li>
            ...
            <div class="content-page">
                ...
                <footer class="footer text-right">
                    @php echo date('Y'); @endphp © Entertainment Incubator 
                </footer>
