                        ...
                        <div class="login-section">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mt-4">
                                    ...
                                    <input type="password" id="loginInput" class="form-control" placeholder="Password" value="{{ old('password') }}" name="password">
                                    @error('password')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="mb-4 mt-3 form-check">
                                    <input type="checkbox" onclick="loginFunction()" class="form-check-input" id="exampleCheck1">
